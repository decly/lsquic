...
enum quic_frame_type
{
    ...
    QUIC_FRAME_STREAM,              /* B *//* 流帧, 用于携带流数据, 同时也明确地创建一条流 */
    ...
    QUIC_FRAME_GOAWAY,              /* G */
    QUIC_FRAME_WINDOW_UPDATE,       /* G *//* 流控控制通知对端连接或流上可以发送的最大数据量 */
    ...
    QUIC_FRAME_STOP_SENDING,        /* I *//* 停止发送帧, 接收到STOP_SENDING意味着对端不会再从该流接收数据 */
